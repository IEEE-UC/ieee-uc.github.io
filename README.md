...
The `widgetbot.json` file contains the server and channel IDs for the Widgetbot announcement widget on the home page. You can change these values to point to a different Discord server or channel.
